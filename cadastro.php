                ...
                <div class="col-sm-12 col-md-12">
                    <form name="insuser" action="cadastroAct.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="idcel" name="celular">
                        </div>
                        <div class="form-group">
                            <label for="idcpf">CPF:</label>
                            <input type="text" class="form-control" id="idcpf" name="cpf">
                        </div>
                        <div class="form-group">
                            <label for="idNasc">Data de nascimento:</label>
                            <input type="date" class="form-control" id="idNasc" name="nasc">
                        </div>
