...
<body class="vender">
    ...
    <div class="container" style="padding-top: 2rem">
        ...
        <form action="venderAct.php" method="post" enctype="multipart/form-data">
            ...
            <select class="form-select" id="marcaSelect" onchange="addMarca()" required>
            ...
            <select class="form-select" id="modeloSelect" name="modelo" onchange="addModelo()" required>
            ...
            <select class="form-select" id="versaoSelect" name="versao" required>
            ...
            <br />
            <select class="form-select" id="corSelect" name="cor" required>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="decimal" name="price" id="price" placeholder="100000" required>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label for="ultRev">Ano da última revisão:</label>
                        <input class="form-control" id="ultRev" name="ultRev" type="number" placeholder="<?php echo date('Y') ?>" required>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        <label for="km">Quilometragem:</label>
                        <input class="form-control" id="km" name="km" type="number" placeholder="50000" required>
                    </div>
                </div>
            </div>
            <div class="row">
